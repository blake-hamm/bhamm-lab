...
|----------|--------------------------------|------------------------------|-----------|----------------------------------------------|----------------------------------------|--------------------------------|
| Method   | Supermicro H12SSL-i            | AMD EPYC 7502    | 128 GB ECC     | 128GB SSD (boot), 1TB NVME (ceph db/wal), 1TB SSD (ceph osd), 3.84 TB SSD (ceph osd), 1TB SSD (VM storage via local-vg), 1TB SSD (garage pcie passthrough), 2x2TB SSD (garage pcie passthrough) | Dual 10 GB NIC SFP+, ipmi, AMD Radeon AI Pro R9700 (Talos llama.cpp VM), Intel Arc A310e (Talos immich/jellyfin VM), SATA pcie | Proxmox, ceph, NUT client |
