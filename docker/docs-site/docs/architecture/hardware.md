...
|----------|--------------------------------|------------------------------|-----------|----------------------------------------------|----------------------------------------|--------------------------------|
| Method   | Supermicro H12SSL-i            | AMD EPYC 7502    | 128 GB ECC     | 128GB SSD (boot), 1.5TB Intel NVMe (ceph db/wal), 1TB NVMe (VM storage via local-vg), 1TB SSD (ceph osd), 3.84TB SSD (ceph osd), 1TB SSD (ceph osd) | Dual 10 GB NIC SFP+, ipmi, AMD Radeon AI Pro R9700, Intel Arc A310e, Intel Battlemage G21, SATA HBA | Proxmox, ceph, NUT client |
